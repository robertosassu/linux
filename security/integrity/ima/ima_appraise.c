...
{
	/*
	 * Add the IMA-Appraisal hooks to the 'integrity' LSM rather than a
	 * standalone 'ima' LSM, to reflect the dependency of IMA to the
	 * integrity subsystem for the management of integrity metadata.
	 */
