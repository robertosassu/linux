...
/*
 * Pass the IMA LSM ID to the 'integrity' LSM for registration of the
 ...
 * ones, by letting the 'integrity' LSM initialize both the 'ima' and 'evm'
 * LSMs in this sequence.
 */
...
/* Introduce a dummy function as 'ima' init function (it cannot be NULL). */
int __init dummy_init_ima_lsm(void)
{
	return 0;
}
