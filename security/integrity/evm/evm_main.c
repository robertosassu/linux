			    ...
			    struct xattr *xattrs)
{
	...
	/*
	 * security_inode_init_security() makes sure that xattrs are contiguous,
	 * there is enough space for security.evm, and that there is a
	 * terminator at the end of the array.
	 */
