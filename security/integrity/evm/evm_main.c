...
{
	/*
	 * Add the EVM hooks to the 'integrity' LSM rather than a standalone
	 * 'evm' LSM, to reflect the dependency of EVM to the integrity
	 * subsystem for the management of integrity metadata.
	 */
	security_add_hooks(evm_hooks, ARRAY_SIZE(evm_hooks), &integrity_lsmid);
}
