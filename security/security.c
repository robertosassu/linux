 ...
 * attribute name suffix (e.g. selinux), to allocate ->value and set it to the
 * attribute value, to set ->value_len to the length of the value.  If the
			       ...
			       void **buffer, bool alloc)
{
	...
	hlist_for_each_entry(hp, &security_hook_heads.inode_getsecurity, list) {
		rc = hp->hook.inode_getsecurity(idmap, inode, name,
						buffer, alloc);
