...
/**
 * security_inode_post_set_acl() - Update inode sec after setting posix acls
 * @dentry: file
 * @acl_name: acl name
 * @kacl: acl struct
 *
 * Update inode security field after successfully setting posix acls on @dentry.
...
/**
 * security_inode_post_remove_acl() - Update inode sec after posix acls removal
 * @idmap: idmap of the mount
 * @dentry: file
 * @acl_name: acl name
 *
 * Update inode security field after successfully removing posix acls on
