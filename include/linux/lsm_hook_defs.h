...
LSM_HOOK(void, LSM_RET_VOID, path_post_mknod, struct user_namespace *mnt_userns,
...
LSM_HOOK(int, 0, inode_create, struct inode *dir, struct dentry *dentry,
	 umode_t mode)
LSM_HOOK(void, LSM_RET_VOID, inode_post_create_tmpfile,
...
LSM_HOOK(int, 0, inode_setattr, struct user_namespace *mnt_userns,
	 struct dentry *dentry, struct iattr *attr)
LSM_HOOK(void, LSM_RET_VOID, inode_post_setattr,
	 struct user_namespace *mnt_userns, struct dentry *dentry, int ia_valid)
...
LSM_HOOK(int, 0, inode_remove_acl, struct user_namespace *mnt_userns,
	 struct dentry *dentry, const char *acl_name)
LSM_HOOK(void, LSM_RET_VOID, inode_post_remove_acl, struct dentry *dentry,
	 const char *acl_name)
