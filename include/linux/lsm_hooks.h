 ...
 *	@idmap contains idmap of the mount.
 ...
 *	@idmap contains the idmap of the mount.
 *	@dir contains the path structure of parent of the new file.
 *	@dentry contains the dentry structure of the new file.
 *	@mode contains the mode of the new file.
 *	@dev contains the undecoded device number. Use new_decode_dev() to get
 ...
 *	identified by @ia_valid for @dentry in @idmap.
 * @path_truncate:
 ...
 *	Update inode security field after successful remove_acl operation on
 *	@dentry in @idmap.
 *	The posix acls are identified by @acl_name.
 * @inode_getsecurity:
